---
title: "Child to Parent Trusts - Windows"
sidebarTitle: "Child → parent: Windows"
description: "Read the Windows child-to-parent trust lab and its SID history prerequisites."
keywords: ["child parent trusts", "Windows", "SID history", "ExtraSids", "trust lab"]
---
...
[SID History Primer](#sid-history-primer) · [ExtraSids Attack - Mimikatz](#extrasids-attack-mimikatz) · [ExtraSids Attack - Rubeus](#extrasids-attack-rubeus) · [Next Steps](#next-steps) · [Continue studying](#continue-studying)

{/* VAULT_QUICK_NAV_END */}

{/* Generated from Active Directory/Continued Lessons/23 Child to Parent Trusts - Windows.md. Edit the Markdown source, then run scripts/sync_site.py. */}

**Lesson 23 of 28** · [AD study path](/active-directory/index)
...
[Previous: Domain Trusts Primer](/active-directory/trusts-primer) · [Next: Child to Parent Trusts - Linux](/active-directory/trusts-child-parent-linux)

[Preserved full capture](/downloads/active-directory-continuation-2026-09-09-d4996d60.txt). Source lines 3003–3339. Illustration captions from the text export are retained.
