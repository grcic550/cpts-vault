---
title: "Child to Parent Trusts - Linux"
sidebarTitle: "Child to Parent Trusts - Linux"
description: "Read the Linux child-to-parent trust lab and compare its collected domain context."
keywords: ["child parent trusts", "Linux", "Impacket", "SID", "trust lab"]
---
...
[Performing DCSync with secretsdump.py](#performing-dcsync-with-secretsdump-py) · [Performing SID Brute Forcing using lookupsid.py](#performing-sid-brute-forcing-using-lookupsid-py) · [Looking for the Domain SID](#looking-for-the-domain-sid) · [Grabbing the Domain SID & Attaching to Enterprise Admin's RID](#grabbing-the-domain-sid-&-attaching-to-enterprise-admins-rid) · [Constructing a Golden Ticket using ticketer.py](#constructing-a-golden-ticket-using-ticketer-py) · [Setting the KRB5CCNAME Environment Variable](#setting-the-krb5ccname-environment-variable) · [Getting a SYSTEM shell using Impacket's psexec.py](#getting-a-system-shell-using-impackets-psexec-py) · [Performing the Attack with raiseChild.py](#performing-the-attack-with-raisechild-py) · [More Fun](#more-fun) · [Continue studying](#continue-studying)

{/* VAULT_QUICK_NAV_END */}

{/* Generated from Active Directory/Continued Lessons/24 Child to Parent Trusts - Linux.md. Edit the Markdown source, then run scripts/sync_site.py. */}

**Lesson 24 of 28** · [AD study path](/active-directory/index)
...
```shellsession
grcic550@htb[/htb]$ export KRB5CCNAME=hacker.ccache
```
...
[Previous: Child to Parent Trusts - Windows](/active-directory/trusts-child-parent-windows) · [Next: Cross-Forest Trusts - Windows](/active-directory/trusts-cross-forest-windows)

[Preserved full capture](/downloads/active-directory-continuation-2026-09-09-d4996d60.txt). Source lines 3340–3581. Illustration captions from the text export are retained.
