---
title: "DCSync Lab"
sidebarTitle: "DCSync Lab"
description: "Understand replication permissions and follow the captured DCSync lab transcript."
keywords: ["DCSync", "replication", "GetChanges", "GetChangesAll", "permissions"]
---
...
[Scenario Setup](#scenario-setup) · [What is DCSync and How Does it Work?](#what-is-dcsync-and-how-does-it-work) · [Moving On](#moving-on) · [Continue studying](#continue-studying)

{/* VAULT_QUICK_NAV_END */}

{/* Generated from Active Directory/Continued Lessons/17 DCSync Lab.md. Edit the Markdown source, then run scripts/sync_site.py. */}

**Lesson 17 of 28** · [AD study path](/active-directory/index)
...
```shellsession
grcic550@htb[/htb]$ ls inlanefreight_hashes*
...
[Previous: ACL Abuse Tactics](/active-directory/acl-abuse-lab) · [Next: Privileged Remote Access](/active-directory/privileged-access)

[Preserved full capture](/downloads/active-directory-continuation-2026-09-09-d4996d60.txt). Source lines 554–784. Illustration captions from the text export are retained.
