---
title: "Cross-Forest Trusts - Windows"
sidebarTitle: "Cross-Forest Trusts - Windows"
description: "Follow the saved Windows cross-forest enumeration, SPN, and group-membership examples."
keywords: ["cross forest", "Windows", "foreign group membership", "SPN", "trust"]
---

{/* Generated from Active Directory/Continued Lessons/25 Cross-Forest Trusts - Windows.md. Edit the Markdown source, then run scripts/sync_site.py. */}

**Lesson 25 of 28** · [AD study path](/active-directory/index)
...
Diagram showing trust relationship between INLANEFREIGHT.LOCAL and CORP.LOCAL domains, with user migration due to merger. Includes user SIDs and resources.
...
[Previous: Child to Parent Trusts - Linux](/active-directory/trusts-child-parent-linux) · [Next: Cross-Forest Trusts - Linux](/active-directory/trusts-cross-forest-linux)

[Preserved full capture](/downloads/active-directory-continuation-2026-09-09-d4996d60.txt). Source lines 3582–3698. Illustration captions from the text export are retained.
