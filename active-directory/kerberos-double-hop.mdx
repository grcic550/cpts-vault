---
title: "Kerberos Double Hop"
sidebarTitle: "Kerberos Double Hop"
description: "Understand why authentication fails at the second hop and compare the recorded remoting cases."
keywords: ["Kerberos double hop", "second hop", "WinRM", "PSCredential", "PSSession", "authentication"]
---
...
[Background](#background) · [Workarounds](#workarounds) · [Workaround #1: PSCredential Object](#workaround-#1-pscredential-object) · [Workaround #2: Register PSSession Configuration](#workaround-#2-register-pssession-configuration) · [Wrap Up](#wrap-up) · [Continue studying](#continue-studying)

{/* VAULT_QUICK_NAV_END */}

{/* Generated from Active Directory/Continued Lessons/19 Kerberos Double Hop.md. Edit the Markdown source, then run scripts/sync_site.py. */}

**Lesson 19 of 28** · [AD study path](/active-directory/index)
...
Diagram showing attack path: Attack Host to Dev01 (First Hop), then to DC01 (Second Hop).
...
[Previous: Privileged Remote Access](/active-directory/privileged-access) · [Next: Historical AD Vulnerability Labs](/active-directory/historical-vulnerability-labs)

[Preserved full capture](/downloads/active-directory-continuation-2026-09-09-d4996d60.txt). Source lines 1093–1639. Illustration captions from the text export are retained.
