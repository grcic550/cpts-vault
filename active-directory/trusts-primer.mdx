---
title: "Domain Trusts Primer"
sidebarTitle: "Domain Trusts Primer"
description: "Understand trust direction, transitivity, forest boundaries, and enumeration."
keywords: ["domain trusts", "trust direction", "transitive", "SID filtering", "forest boundary"]
---
...
[Scenario](#scenario) · [Domain Trusts Overview](#domain-trusts-overview) · [Enumerating Trust Relationships](#enumerating-trust-relationships) · [Onwards](#onwards) · [Continue studying](#continue-studying)

{/* VAULT_QUICK_NAV_END */}

{/* Generated from Active Directory/Continued Lessons/22 Domain Trusts Primer.md. Edit the Markdown source, then run scripts/sync_site.py. */}

**Lesson 22 of 28** · [AD study path](/active-directory/index)
...
Diagram of servers A, B, C representing domains a.com, b.com, c.com, illustrating A=B, B=C, thus A=C.
...
Diagram of Inlanefreight Forest showing trust types: Parent-child, Cross-link, External, Tree-root, and Forest between domains.
...
Graph showing domain relationships: INLANEFREIGHT.LOCAL connected to LOGISTICS.INLANEFREIGHT.LOCAL and FREIGHT.LOGISTICS.LOCAL. Sidebar with pre-built analytics queries.
...
[Previous: Miscellaneous Misconfigurations](/active-directory/miscellaneous-misconfigurations) · [Next: Child to Parent Trusts - Windows](/active-directory/trusts-child-parent-windows)

[Preserved full capture](/downloads/active-directory-continuation-2026-09-09-d4996d60.txt). Source lines 2776–3002. Illustration captions from the text export are retained.
