---
title: "Additional AD Auditing Tools"
sidebarTitle: "Additional AD Auditing Tools"
description: "Compare the saved PingCastle, ADRecon, and auditing-tool output and reporting context."
keywords: ["AD audit", "PingCastle", "ADRecon", "Purple Knight", "reporting"]
---
...
[Creating an AD Snapshot with Active Directory Explorer](#creating-an-ad-snapshot-with-active-directory-explorer) · [PingCastle](#pingcastle) · [Group Policy](#group-policy) · [ADRecon](#adrecon) · [Continue studying](#continue-studying)

{/* VAULT_QUICK_NAV_END */}

{/* Generated from Active Directory/Continued Lessons/28 Additional AD Auditing Tools.md. Edit the Markdown source, then run scripts/sync_site.py. */}

**Lesson 28 of 28** · [AD study path](/active-directory/index)

> **Saved tool output:** version numbers, expiry messages, and dates below belong to the captured lab output. Use the tool’s current release and licensing information when setting up a new audit.
...
Active Directory Explorer connection window with fields for Connect to, User, Password, and Path, plus options to save the connection.

Once logged in, we can freely browse AD and view information about all objects.

### Browsing AD with AD Explorer

Active Directory Explorer window showing directory structure and attributes for DC=INLANEFREIGHT,DC=LOCAL.
...
Active Directory Explorer window with snapshot dialog open, showing fields for description, path, and server utilization settings.
...
GIF showcasing the report generated by PingCastle.
...
Screenshot of GPO settings showing 'Disallow LM Hash' and 'Default Domain Controllers Policy' with details on creation, modification, and registry settings.
...
[Previous: Hardening Active Directory](/active-directory/hardening) · [Learning log](/active-directory/learning-log)

[Preserved full capture](/downloads/active-directory-continuation-2026-09-09-d4996d60.txt). Source lines 3947–4136. Illustration captions from the text export are retained.
