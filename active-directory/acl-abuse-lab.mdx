---
title: "ACL Abuse Tactics"
sidebarTitle: "ACL Abuse Tactics"
description: "Read the supplied ACL chain, its prerequisites, cleanup, detection, and remediation."
keywords: ["ACL abuse", "GenericWrite", "group membership", "SPN", "cleanup", "remediation"]
---
...
[Abusing ACLs](#abusing-acls) · [Cleanup](#cleanup) · [Detection and Remediation](#detection-and-remediation) · [Continue studying](#continue-studying)

{/* VAULT_QUICK_NAV_END */}

{/* Generated from Active Directory/Continued Lessons/16 ACL Abuse Tactics.md. Edit the Markdown source, then run scripts/sync_site.py. */}

**Lesson 16 of 28** · [AD study path](/active-directory/index)
...
Windows Event Viewer showing Security log entry for Event ID 5136, indicating a Directory Service change by administrator on 3/24/2022 at 10:53 AM. Audit Success for INLANEFREIGHT.LOCAL domain.
...
Windows Event Viewer displaying Security log entry for Event ID 5136, showing Directory Service change details with audit success on 3/24/2022 at 10:53 AM.
...
[Previous: ACL Enumeration](/active-directory/acl-enumeration) · [Next: DCSync Lab](/active-directory/dcsync-lab)

[Preserved full capture](/downloads/active-directory-continuation-2026-09-09-d4996d60.txt). Source lines 296–553. Illustration captions from the text export are retained.
