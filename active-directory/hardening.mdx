...
sidebarTitle: "Hardening Active Directory"
description: "Review people, process, and technology controls alongside the captured attack and defense table."
keywords: ["AD hardening", "Protected Users", "defense", "MITRE ATT&CK", "audit", "security controls"]
---

{/* Generated from Active Directory/Continued Lessons/27 Hardening Active Directory.md. Edit the Markdown source, then run scripts/sync_site.py. */}

**Lesson 27 of 28** · [AD study path](/active-directory/index)
...
GIF showcasing the Credential Access tactics in the MITRE ATT&CK framework.
...
[Previous: Cross-Forest Trusts - Linux](/active-directory/trusts-cross-forest-linux) · [Next: Additional AD Auditing Tools](/active-directory/auditing-tools)

[Preserved full capture](/downloads/active-directory-continuation-2026-09-09-d4996d60.txt). Source lines 3825–3946. Illustration captions from the text export are retained.
