---
title: "Attacking DNS: Module Notes"
sidebarTitle: "DNS module notes"
description: "Study the saved DNS zone-transfer, subdomain-discovery, domain-takeover, and local cache-poisoning examples."
keywords: ["attacking dns", "zone transfer", "subdomain takeover", "subbrute", "dns spoofing", "cache poisoning"]
---
...
[Attacking DNS](#attacking-dns) · [Enumeration](#enumeration) · [DNS Zone Transfer](#dns-zone-transfer) · [DIG - AXFR Zone Transfer](#dig-axfr-zone-transfer) · [Domain Takeovers & Subdomain Enumeration](#domain-takeovers-&-subdomain-enumeration) · [Subdomain Enumeration](#subdomain-enumeration) · [Subbrute](#subbrute) · [DNS Spoofing](#dns-spoofing) · [Local DNS Cache Poisoning](#local-dns-cache-poisoning)

{/* VAULT_QUICK_NAV_END */}

{/* Generated from Modules/Attacking Common Services/03 Attacking DNS.md. Edit the Markdown source, then run scripts/sync_site.py. */}
...
Source: [original export](/downloads/attacking-common-services-section-9-onward-9e42cc4d.txt), lines 790–1011.
