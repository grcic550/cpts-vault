---
title: "Attacking RDP: Module Notes"
sidebarTitle: "RDP module notes"
description: "Review RDP discovery, password-testing examples, session hijacking, and the Restricted Admin context for pass-the-hash."
keywords: ["attacking rdp", "crowbar", "hydra", "session hijacking", "restricted admin", "pass the hash", "3389"]
---
...
[Attacking RDP](#attacking-rdp) · [Misconfigurations](#misconfigurations) · [Crowbar - RDP Password Spraying](#crowbar-rdp-password-spraying) · [Hydra - RDP Password Spraying](#hydra-rdp-password-spraying) · [RDP Login](#rdp-login) · [Protocol Specific Attacks](#protocol-specific-attacks) · [RDP Session Hijacking](#rdp-session-hijacking) · [RDP Pass-the-Hash (PtH)](#rdp-pass-the-hash-pth) · [Adding the DisableRestrictedAdmin Registry Key](#adding-the-disablerestrictedadmin-registry-key)

{/* VAULT_QUICK_NAV_END */}

{/* Generated from Modules/Attacking Common Services/02 Attacking RDP.md. Edit the Markdown source, then run scripts/sync_site.py. */}
...
Source: [original export](/downloads/attacking-common-services-section-9-onward-9e42cc4d.txt), lines 607–789.
