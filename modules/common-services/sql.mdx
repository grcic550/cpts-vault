---
title: "Attacking SQL Databases: Module Notes"
sidebarTitle: "SQL module notes"
description: "Work through MySQL and MSSQL authentication, queries, file access, command execution, impersonation, and linked-server examples."
keywords: ["attacking sql", "mssql", "mysql", "sqlcmd", "xp_cmdshell", "impersonation", "linked servers", "secure_file_priv"]
---
...
[Attacking SQL Databases](#attacking-sql-databases) · [Enumeration](#enumeration) · [Banner Grabbing](#banner-grabbing) · [Authentication Mechanisms](#authentication-mechanisms) · [Misconfigurations](#misconfigurations) · [Privileges](#privileges) · [Protocol Specific Attacks](#protocol-specific-attacks) · [Read/Change the Database](#read/change-the-database) · [MySQL - Connecting to the SQL Server](#mysql-connecting-to-the-sql-server) · [Sqlcmd - Connecting to the SQL Server](#sqlcmd-connecting-to-the-sql-server) · [SQL Default Databases](#sql-default-databases) · [SQL Syntax](#sql-syntax) · [Show Databases](#show-databases) · [Select a Database](#select-a-database) · [Show Tables](#show-tables) · [Execute Commands](#execute-commands) · [Write Local Files](#write-local-files) · [MySQL - Write Local File](#mysql-write-local-file)

{/* VAULT_QUICK_NAV_END */}

{/* Generated from Modules/Attacking Common Services/01 Attacking SQL Databases.md. Edit the Markdown source, then run scripts/sync_site.py. */}
...
Source: [original export](/downloads/attacking-common-services-section-9-onward-9e42cc4d.txt), lines 1–606.
