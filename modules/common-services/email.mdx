---
title: "Attacking Email Services: Module Notes"
sidebarTitle: "Email module notes"
description: "Follow mail-service discovery, account enumeration, password testing, open-relay checks, and the module's historical vulnerability examples."
keywords: ["attacking email", "mx records", "vrfy", "expn", "o365spray", "hydra", "open relay", "exchange"]
---
...
[Attacking Email Services](#attacking-email-services) · [Enumeration](#enumeration) · [Host - MX Records](#host-mx-records) · [DIG - MX Records](#dig-mx-records) · [Host - A Records](#host-a-records) · [Misconfigurations](#misconfigurations) · [Authentication](#authentication) · [VRFY Command](#vrfy-command) · [EXPN Command](#expn-command) · [RCPT TO Command](#rcpt-to-command) · [USER Command](#user-command) · [Cloud Enumeration](#cloud-enumeration) · [O365 Spray](#o365-spray) · [Password Attacks](#password-attacks) · [Hydra - Password Attack](#hydra-password-attack) · [O365 Spray - Password Spraying](#o365-spray-password-spraying) · [Protocol Specifics Attacks](#protocol-specifics-attacks) · [Open Relay](#open-relay)

{/* VAULT_QUICK_NAV_END */}

{/* Generated from Modules/Attacking Common Services/04 Attacking Email Services.md. Edit the Markdown source, then run scripts/sync_site.py. */}

Organized from the supplied HTB study export. Lab addresses, credentials, and historical examples are retained as examples.
...
Source: [original export](/downloads/attacking-common-services-section-9-onward-9e42cc4d.txt), lines 1012–1436.
